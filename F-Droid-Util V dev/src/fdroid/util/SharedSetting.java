...
public class SharedSetting implements SharedPreferences,
	...
	public static void setCommitWhenEditorChanged(boolean commit_when_editor_changed) {
		SharedSetting.commit_when_editor_changed = commit_when_editor_changed;
	}

	public static void setApplyWhenEditorChanged(boolean apply_when_editor_changed) {
